...
/**
 * Copy of Shell class from libsuperuser, add exit code to return.
 */
public class Shell {
    ...
    public static class Result implements Parcelable {
        ...
        public static final int EXIT_IO_EXCEPTION = 256;
        public static final int EXIT_INTERRUPTED_EXCEPTION = 257;
     ...
     */
    @Deprecated
    public static Result run(String shell, String[] commands, boolean wantSTDERR) {
    ...
    public static Result run(String shell, String[] commands, String[] environment,
        ...
        try {
            ...
            res = null;
            exitCode = Result.EXIT_IO_EXCEPTION;
        } catch (InterruptedException e) {
            // this should really be re-thrown
            res = null;
            exitCode = Result.EXIT_INTERRUPTED_EXCEPTION;
        }

        Debug.logCommand(String.format("[%s%%] END", shell.toUpperCase(Locale.ENGLISH)));
        return new Result(exitCode, res);
    }
    ...
    public static class SH {
         ...
         * @return Result of the commands
         */
        public static Result run(List<String> commands) {
    ...
    public static class SU {
        ...
        public static boolean available() {
            ...
            List<String> ret = run(Shell.availableTestCommands).output;
