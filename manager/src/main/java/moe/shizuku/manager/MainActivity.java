...
import moe.shizuku.manager.widget.VerticalPaddingDecoration;
...
public class MainActivity extends AppBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHomeModel = new ViewModelProvider(this).get("home", HomeViewModel.class);
        ...
        BorderRecyclerView recyclerView = findViewById(android.R.id.list);
        recyclerView.setAdapter(mAdapter);
        recyclerView.addItemDecoration(new VerticalPaddingDecoration(this, 4));
        recyclerView.getBorderViewDelegate().setBorderVisibilityChangedListener((top, oldTop, bottom, oldBottom) -> {
            getAppBar().setRaised(!top);
        });
