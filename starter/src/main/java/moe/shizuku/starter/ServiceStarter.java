...
public class ServiceStarter {
    ...
    private static void sendBinder(IBinder binder, String token, boolean retry) {
            ...
            public void run() {
                try {
                    ...
                    if (provider == null) {
                        ...
                        processProvider(provider,binder,token,packageName,userId,retry,this);
                    }
    ...
    private static void processProvider(IContentProvider provider, IBinder binder, String token, String packageName, int userId, boolean retry,Runnable retryRunnable) {
        String name = packageName + ".shizuku";
