...
interface ISms {
     ...
     */
    List<SmsRawData> getAllMessagesFromIccEfForSubscriber(int subId, String callingPkg);
     ...
     *
     */
     boolean updateMessageOnIccEfForSubscriber(int subId, String callingPkg,
     ...
     *  which cause smaller number of SMS to be sent checking period.
     * @param deliveryIntent if not NULL this <code>PendingIntent</code> is
     *  broadcast when the message is delivered to the recipient.  The
     *  raw pdu of the status report is the extended data ("pdu").
     * @param subId the subId id.
     */
     ...
     *   be automatically persisted the SMS db. It only affects messages sent
     *   by a non-default SMS app. Currently only the carrier app can set this
     *   parameter to false to skip auto message persistence.
     */
    void sendTextForSubscriber(int subId, String callingPkg, String destAddr,
     ...
     * @param subId the subId on which the SMS has to be sent.
     */
    void sendTextForSubscriberWithSelfPermissions(int subId, String callingPkg,
     ...
     * @param parts an <code>ArrayList</code> of strings that, order,
     ...
     *   to the recipient.  The raw pdu of the status report is the
     *   extended data ("pdu").
     * @param subId the subId on which the SMS has to be sent.
     * @param persistMessageForNonDefaultSmsApp whether the sent message should
     *   be automatically persisted the SMS db. It only affects messages sent
     ...
     *   parameter to false to skip auto message persistence.
     */
    void sendMultipartTextForSubscriber(int subId, String callingPkg,
     ...
     *
     * @param messageIdentifier Message identifier as specified TS 23.041 (3GPP) or
     *   C.R1001-G (3GPP2)
     * @param subId for which the broadcast has to be enabled
     * @param ranType as defined class SmsManager, the value can be one of these:
     ...
     *
     * @param startMessageId first message identifier as specified TS 23.041 (3GPP) or
     *   C.R1001-G (3GPP2)
     * @param endMessageId last message identifier as specified TS 23.041 (3GPP) or
     *   C.R1001-G (3GPP2)
     * @param subId for which the broadcast has to be enabled
     * @param ranType as defined class SmsManager, the value can be one of these:
     *    android.telephony.SmsMessage.CELL_BROADCAST_RAN_TYPE_GSM
    ...
    /**
     * User needs to pick SIM for SMS if multiple SIMs present and if current subId passed is not
     * active/valid.
     ...
     *   extended data ("pdu").
     */
    void sendStoredMultipartText(int subId, String callingPkg, Uri messageUri,
     ...
     */
    String createAppSpecificSmsToken(int subId, String callingPkg, PendingIntent intent);
}
